...
#if defined(BOARD_IS_ALIF_FPGABALLETTO_B1_VARIANT)
#include "app_map.h"
...
*/
	...
	pinconf_set(PORT_8,  PIN_0, PINMUX_ALTERNATE_FUNCTION_1, PADCTRL_OUTPUT_DRIVE_STRENGTH_12MA);    // SCLKN
	pinconf_set(PORT_5,  PIN_7, PINMUX_ALTERNATE_FUNCTION_1, PADCTRL_OUTPUT_DRIVE_STRENGTH_12MA | PADCTRL_SLEW_RATE_FAST);    // CS
	pinconf_set(PORT_10, PIN_7, PINMUX_ALTERNATE_FUNCTION_1, PADCTRL_OUTPUT_DRIVE_STRENGTH_12MA | PADCTRL_READ_ENABLE); // this sets pad control properly for 10_7
	pinconf_set(PORT_5,  PIN_6, PINMUX_ALTERNATE_FUNCTION_1, PADCTRL_OUTPUT_DRIVE_STRENGTH_12MA | PADCTRL_READ_ENABLE); // this sets rxds_c pinmux properly for 10_7
...
*/
	...
	/* UART4 interface */
	pinconf_set(PORT_3, PIN_6, PINMUX_ALTERNATE_FUNCTION_2, config_uart_rx);    // P12_1: RX  (mux mode 2)  uart4_rx_b
	pinconf_set(PORT_3, PIN_7, PINMUX_ALTERNATE_FUNCTION_2, 0);                 // P12_2: TX  (mux mode 2)  uart4_tx_b
